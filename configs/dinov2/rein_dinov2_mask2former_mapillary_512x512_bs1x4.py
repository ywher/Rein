# dataset config
_base_ = [
    "../_base_/datasets/dg_mapillary_512x512.py",
...
train_cfg = dict(type="IterBasedTrainLoop", max_iters=80000, val_interval=4000)  # 40000, 10000
...
default_hooks = dict(
    ...
    checkpoint=dict(
        type="CheckpointHook", by_epoch=False, interval=8000, max_keep_ckpts=3  # 4000
    ),
